...
PERSONAS = {
    "serenity": (
        "Serenity(AI 供應鏈瓶頸視角)",
        "核心信念:大回報藏喺『系統擴張時最難繞過嘅咽喉』。喺 AI/半導體/機械人/光通訊"
        "呢啲擴張中嘅產業,專搵供應受限、難替代嘅環節 —— 瓶頸特徵:供應商極少、驗證期長、"
        "擴產難、有認證/專利/標準護城河(例:先進封裝、HBM、光引擎、互連、電力散熱)。"
        "審視每隻持倉:①係咪真喺瓶頸核心,定只係沾個 AI 題材邊(thematic window-dressing)?"
        "②結論只可以建基於硬證據 —— 申報文件、業績會、客戶認證、專利、標準、可信媒體,"
        "唔信社交媒體吹風。③留意產能週期同庫存拐點、二階受惠者。"),
    "buffett": (
        "巴菲特(價值 / 護城河)",
